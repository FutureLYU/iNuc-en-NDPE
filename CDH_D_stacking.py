...
clf_LG = LogisticRegression(C=0.5464, solver='liblinear', random_state=RANDOM_SEED, penalty='l2')
...
# sclf.fit(X_C, Y_C)
scores_ST = cross_validate(sclf, X_C, Y_C, cv=6, scoring=scorer, n_jobs=-1)
